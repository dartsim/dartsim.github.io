...
Please reference the source code in [**tutorialBiped.cpp**](https://github.com/dartsim/dart/blob/v6.1.0/tutorials/tutorialBiped.cpp) and [**tutorialBiped-Finished.cpp**](https://github.com/dartsim/dart/blob/v6.1.0/tutorials/tutorialBiped-Finished.cpp).
...
load in a World from [**biped.skel**](https://github.com/dartsim/dart/blob/v6.1.0/data/skel/biped.skel) and assign the bipedal figure to a
