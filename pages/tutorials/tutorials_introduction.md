...
the tutorial code in the directory: [dart/tutorials](https://github.com/dartsim/dart/tree/release-6.0/tutorials). For each of the
four tutorials, we provide the skeleton code as the starting point
(e.g. [tutorialMultiPendulum.cpp](https://github.com/dartsim/dart/blob/release-6.0/tutorials/tutorialMultiPendulum.cpp)) and
the final code as the answer to the tutorial (e.g. [tutorialMultiPendulum-Finished.cpp](https://github.com/dartsim/dart/blob/release-6.0/tutorials/tutorialMultiPendulum-Finished.cpp)). The examples are based on the APIs of DART 6.0.
