...
permalink: dartpy_examples_operational_space_control.html
folder: dartpy_examples
---

## Screenshot

{% include image.html file="dartpy_examples/dartpy_examples_operational_space_control.png" alt="operational space control" max-width="640"  caption="Operational space control example." %}
